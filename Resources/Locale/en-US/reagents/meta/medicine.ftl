...
reagent-desc-phalanximine = An advanced chemical used in the treatment of cancer. Causes moderate radiation poisoning and acid burns on organics and vomiting. Can potentially remove the death gene on plants.
...
reagent-desc-ambuzol-plus = Further engineered with the omnizine, inoculates the living against the infection.
